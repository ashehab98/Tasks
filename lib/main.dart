...
//برنامج فيه list أسماء أفلام هلف عليها بإستخدام foreach وأخزن أسماء الأفلام التى تبدأ بحرف a سواء الحرف capital or small فى list جديدة وطباعتهم
void task2() {
  List<String> movies = [
    "alllll 1",
    "Aqqqq 2",
...
//2 ميثود واحده تطبع الارقام الزوجيه و التانيه تطبع الارقام الفرديه من و الى رقم اليوزر اللى يقوم بتدخيله
void task4Even() {
...
//برنامج بياخد حرف او حرفين او تلاتة ويدور فى list فيها كلمات ولو لقى اي كلمه موجوده بتبدأ بالحرف ده او الاتنين او التلاته ياخدهم ويضيفهم فى list جديده
void task5() {
...
//برنامج ياخد جملة من اليوزر وتقسمها كلمات وتخزنها في list وتطبع ال list الجديدة
void task6() {
...
// برنامج فيه list وفيها أسماء و أطبع اسم واعدى اسم
void task9() {
  List<String> names = [
    "Ahmed",
    "Ali",
...
// برنامج ياخد أسماء من اليوزر ويخزنها في list ولو اليوزر كتب كلمة " end or exit or close " البرنامج يقف وميكملش تخزين
void task10() {
  List<String> list = [];
  while (true) {
    print("Enter names");
